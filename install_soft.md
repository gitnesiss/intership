...
- 1 [Установка Python в Windows](#1-установка-python-в-windows)
  - 1.1 [Проверяем наличие Python и устанавливаем его](#11-проверяем-наличие-python-и-устанавливаем-его)
  - 1.2 [Устаналвиваем PIP (предпочитаемый установщик программ) для Python и обновляем его](#12-устаналвиваем-pip-предпочитаемый-установщик-программ-для-python-и-обновляем-его)
  - 1.3 [Установка PyInstaller для создания исполняемого файла](#13-установка-pyinstaller-для-создания-исполняемого-файла)
  - 1.4 [Установка библиотеки OpenCV](#14-установка-библиотеки-opencv)
...
## 1.4 Установка библиотеки OpenCV
