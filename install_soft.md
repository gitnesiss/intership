...
## 1.4 Установка библиотеки pyqt-tools для установки дополнительных инструметов и плагинов для Python

```
pip install pyqt6-tools
```

## 1.5 Установка библиотеки pymavlink для работы с протоколом MAVLink 
...
## 1.6 Установка библиотеки для работы с Serial port'ом в Python
